...
KNOWN = {
 (0xA3,0x00): [
    ...
    (24,2,"максимальный базал (кандидат)","0,025 Ед → 320=8,0 Ед (menu_04, №7)","🟡"),
    (26,2,"максимальный болюс (кандидат)","0,025 Ед → 480=12,0 Ед (menu_03, №7)","🟡"),
 ...
 (0xA3,0x0C): [ (3,1,"напряжение батареи","0,01 В → 136=1,36 В","🟢") ],
}
